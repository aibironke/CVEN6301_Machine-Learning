...
The repository covers four distinct applications:

1. Concrete crack detection using Convolutional Neural Networks (CNNs)
2. Groundwater vulnerability assessment
3. Groundwater contamination prediction and risk evaluation
4. Groundwater level forecasting using time series analysis

---

## Repository Structure

CVEN6301_Machine-Learning/
│
├── CNN/
...
Research interests include machine learning, geospatial analytics, infrastructure resilience, transportation systems, and environmental modeling.
